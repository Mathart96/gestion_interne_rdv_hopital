...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<ul class="navbar-nav">
			...
			<li><a href="Liste_rdv.php" class="btn btn-success">RENDEZ-VOUS PATIENT</a></li>
			<li><a href="Planing_Medecin.php" class="btn btn-success">PLANING MEDECIN</a></li>------------------------------------------------------------------------------------------------------------
		</ul>
		<a href="AjoutRdv.php" class="btn btn-success"> Ajouter Rendez-vous</a>
		<a href="../index.php" class="btn btn-info"> Deconnexion</a>

	</nav>
	<div class="container">
		<div class="panel panel-primary">
			<div class="navbar navbar-expand-sm bg-info navbar-info"> Liste des rendez-vous</div>
