...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<ul class="navbar-nav">
			<li><a href="../index.php"class="btn btn-success">Acceuil</a></li> 
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class=" navbar navbar-expand-sm bg-info navbar-info"> LISTE DES TRAVAILLEURS ENREGISTRES</div>
			<div class="panel-body">
				<a href="AjoutAdmin.php" class="btn btn-success"> AJOUTER TRAVAILLEUR</a>
